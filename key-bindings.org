...
- VS Code: Prefer bindings over translating at the lower layer? Or not?
    - It can recognize ~super~ (~cmd~) modifier, but has different key bindings depending on the OS.
